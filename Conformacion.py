...
def Conformacion(usuario,puesto):
  ...
  tipo_10= placeholder12_10.selectbox("Tipo", options=("Ordinario","Corrección Primera Revisión","Corrección Segunda Revisión","Corrección Tercera o Más Revisiones"), key="tipo_10")
