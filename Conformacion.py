...
def Conformacion(usuario,puesto):
  ...
  tipo_10= placeholder12_10.selectbox("Tipo", options=("Ordinario","Corrección Primera Revisión","Corrección Primera Reinspección","Corrección Segunda Reinspección"), key="tipo_10")
