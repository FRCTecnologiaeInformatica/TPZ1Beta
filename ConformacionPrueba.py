...
def Conformacion(usuario,puesto):
  ...
  bloque_10= placeholder9_10.number_input("Bloque",max_value=1000000000,step=1,key="bloque_10")
  ...
  # ----- Capacitación ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,proceso,usuario,nombre,horario,fecha,bloque,estado,predios,horas,puesto,tipo,supervisor)VALUES('{marca_10}','Conformación','{usuario}','{nombre_10}','{horario_10}','{fecha_10}','{bloque_10}','{estado_10}','{predios_10}','{horas_10}','{puesto}','{tipo_10}','{supervisor_10}')")
    con.commit()
