...
def CC_IFI(usuario,puesto):
  ...
  estado_12= placeholder11_12.selectbox("Estado", options=("En Proceso","Aprobado","Rechazado","Primera Reinspección Aprobada","Primera Reinspección Rechazada","Segunda Reinspección Aprobada","Segunda Reinspección Rechazada","Tercera o Más Reinspecciones Aprobada","Tercera o Más Reinspecciones Rechazada"), key="estado_12")
