...
def CC_IFI(usuario,puesto):
  ...
  fecha_12= placeholder8_12.date_input("Fecha",value=default_date,key="fecha_12")

  placeholder9_12= st.empty()
  bloque_12= placeholder9_12.number_input("Bloque",min_value=10000000,max_value=99999999,step=1,key="bloque_11")
