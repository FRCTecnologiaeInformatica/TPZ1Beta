...
def IFIII(usuario,puesto):
  ...
  fecha_5= placeholder8_5.date_input("Fecha",value=default_date,key="fecha_5")

  placeholder9_5= st.empty()
  bloque_5= placeholder9_5.number_input("Bloque o Distrito",min_value=10000000,max_value=99999999,step=1,key="bloque_5")
