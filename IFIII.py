...
def IFIII(usuario,puesto):
  ...
  tipo_5= placeholder12_5.selectbox("Tipo",options=("Ordinario","Corrección Primera Revisión","Corrección Primera Reinspección","Corrección Segunda Reinspección"), key="tipo_5")
