...
def IFIII(usuario,puesto):
  ...
  tipo_5= placeholder12_5.selectbox("Tipo",options=("Ordinario","Corrección Primera Revisión","Corrección Segunda Revisión","Corrección Tercera o Más Revisiones"), key="tipo_5")
