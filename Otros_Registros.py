...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Otros"),key="motivo_13")
    ...
    otros_registros_historial_13 = placeholder15_13.subheader("Historial")

    placeholder16_13 = st.empty()
    fecha_de__inicio_13 = placeholder16_13.date_input("Fecha de Inicio",value=default_date_13,key="fecha_de_inicio_13")

    placeholder17_13 = st.empty()
    fecha_de__finalizacion_13 = placeholder17_13.date_input("Fecha de Finalización",value=default_date_13,key="fecha_de_finalizacion_13")
      
    placeholder18_13 = st.empty()
    filtro_13 = placeholder18_13.selectbox("Filtro", options=("Todos","Operarios","Propio","Personal Asignado"), key="filtro_13")
    ...
    placeholder11_13= st.empty()
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Digitalización de Planos","Proyecto Piloto España","Otros"),key="motivo_13")
    ...
    placeholder16_13 = st.empty()
    fecha_de__inicio_13 = placeholder13_13.date_input("Fecha de Inicio",value=default_date_13,key="fecha_de_inicio_13")
    ...
    if filtro_13=="Todos":
      ...
      data = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,morivo,horas,observaciones,reporte from otros_registros where supervisor='{nombre_13}' and fecha>='{fecha_de__inicio_13}' and fecha<='{fecha_de__finalizacion_13}'", con)
    ...
    fecha_de__finalizacion_13 = placeholder21_13.date_input("Fecha de Finalización",value=default_date_13,key="fecha_de_finalizacion_13")
      
    data = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,motivo,horas,observaciones,reporte from otros_registros where usuario='{usuario}' and fecha>='{fecha_de__inicio_13}' and fecha<='{fecha_de__finalizacion_13}'", con)

  placeholder22_13 = st.empty()
  histo_13= placeholder22_13.dataframe(data=data)

  placeholder23_13 = st.empty()
  descarga_13 = placeholder23_13.download_button("Decargar CSV",data=data.to_csv(),mime="text/csv",key="descarga_13")
