...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Digitalización de Planos","Proyecto Piloto España","Entregas","Supervisión","Libre por Cumpleaños","Otros"),key="motivo_13")
    ...
    filtro_13 = placeholder18_13.selectbox("Filtro", options=("Todos","Operarios","Propio","Personal Asignado","Reportados"), key="filtro_13")
