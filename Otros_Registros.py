...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Digitalización de Planos","Proyecto Piloto España","Entregas",key="motivo_13")
