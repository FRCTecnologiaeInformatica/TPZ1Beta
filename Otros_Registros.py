...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Reunión","Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Digitalización de Planos","Proyecto Piloto España","Entregas","Supervisión","Libre por Cumpleaños","Exposición Pública","Otros"),key="motivo_13")
    ...
    placeholder11_13= st.empty()
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Reunión","Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Digitalización de Planos","Proyecto Piloto España","Entregas","Supervisión","Libre por Cumpleaños","Otros"),key="motivo_13")
