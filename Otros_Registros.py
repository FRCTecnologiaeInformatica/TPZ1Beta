...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    placeholder11_13= st.empty()
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Incapacidad","Vacaciones","Fallos en Aplicativo","Fallos de Conexión","Actualización de Insumos","Otros"),key="motivo_13")
