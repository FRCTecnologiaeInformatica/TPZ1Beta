...
def Validacion(usuario,puesto):
  ...
  bloque_15= placeholder10_15.text_input("Bloque",key="bloque_15")
  ...
  tipo_15= placeholder12_15.selectbox("Tipo", options=("Ordinario","Georreferenciación","Corrección Georreferenciación","Corrección Primera Revisión","Corrección Primera Reinspección"), key="tipo_15")
