...
def IFII(usuario,puesto):
  ...
  estado_4= placeholder12_4.selectbox("Tipo",options=("Ordinario","Corrección Primera Revisión","Corrección Segunda Revisión","Corrección Tercera o Más Revisiones"), key="tipo_4")
