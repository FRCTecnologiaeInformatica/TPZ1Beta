...
def IFII(usuario,puesto):
  ...
  estado_4= placeholder12_4.selectbox("Tipo",options=("Ordinario","Corrección Primera Revisión","Corrección Primera Reinspección","Corrección Segunda Reinspección"), key="tipo_4")
