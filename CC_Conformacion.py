...
def CC_Conformacion(usuario,puesto):
  ...
  estado_11= placeholder11_11.selectbox("Estado",options=("En Proceso","Aprobado","Rechazado","Primera Reinspección Aprobada","Primera Reinspección Rechazada","Segunda Reinspección Aprobada","Segunda Reinspección Rechazada","Tercera o Más Reinspecciones Aprobada","Tercera o Más Reinspecciones Rechazada"), key="estado_11")
