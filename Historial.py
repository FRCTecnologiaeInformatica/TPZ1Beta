...
def Historial(usuario,puesto):
  ...
  if puesto=="Supervisor" or puesto=="Coordinador":    
    ...
    proceso_7_s = placeholder11_7.selectbox("Proceso", options=("Todos","Conformación","Control de Calidad Conformación","Validación","Información Final I","Control de Calidad IF I","Información Final II","Información Final III","Digitalización de Planos","Sectores Circulares"), key="proceso_7_s")
  ...
  # ----- Operario Catastral ---- #
    ...
    proceso_7_o= placeholder33_7.selectbox("Proceso", options=("Todos","Conformación","Control de Calidad Conformación","Validación","Información Final I","Control de Calidad IF I","Información Final II","Información Final III","Digitalización de Planos","Sectores Circulares"), key="proceso_7_o")
