...
def IFI(usuario,puesto):
  ...
  tipo_3= placeholder12_3.selectbox("Tipo", options=("Ordinario","Corrección Primera Revisión","Corrección Segunda Revisión","Corrección Tercera o Más Revisiones"), key="tipo_3")
