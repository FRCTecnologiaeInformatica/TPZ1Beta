...
def IFI(usuario,puesto):
  ...
  default_date_3 = datetime.now(pytz.timezone('America/Chicago'))
  ...
  tipo_3= placeholder12_3.selectbox("Tipo", options=("Ordinario","Corrección Primera Revisión","Corrección Primera Reinspección","Corrección Segunda Reinspección"), key="tipo_3")
